...
-   **機械学習プロジェクトのためのメタパッケージ開発 (R)** 【業務内容と技術要素】
    -   データ分析における「属人的なノウハウ」を誰にでも利用可能・再現可能にするためのパッケージを開発
    -   R 言語を利用し、パッケージを開発 (アルファ版のステージ)
...
-   **機械学習分析結果のダッシュボード開発 (R/Python)** 【業務内容と技術要素】
...
-   **投資アルゴリズムの調査・研究・開発 (R/Python)** 【業務内容と技術要素】
...
-   **米国 ETF (上場投資信託) のポートフォリオ構築プラットフォーム (R/Stan/C#)** 【業務内容と技術要素】
